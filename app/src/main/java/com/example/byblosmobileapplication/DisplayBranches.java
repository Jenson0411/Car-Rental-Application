...
public class DisplayBranches extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_branches);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent1 = new Intent(DisplayBranches.this, DisplayBranchServices.class);
        ...
        dataRefBranches.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                BranchList branchesAdapter=new BranchList(DisplayBranches.this,branchList);
    ...
    public void DBbackBnt(View view){
